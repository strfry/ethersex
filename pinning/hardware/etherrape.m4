...
pin(MBI5030_CLK0, PA2, OUTPUT)
pin(MBI5030_LE0, PA0, OUTPUT)
pin(MBI5030_SDO0, PA1, OUTPUT)

pin(MBI5030_CLK1, PC2, OUTPUT)
pin(MBI5030_LE1, PC0, OUTPUT)
pin(MBI5030_SDO1, PC1, OUTPUT)


pin(REMOTEPOWER4_ON, PD0, OUTPUT)
pin(REMOTEPOWER4_OFF, PD1, OUTPUT)
pin(REMOTEPOWER3_ON, PD2, OUTPUT)
pin(REMOTEPOWER3_OFF, PD3, OUTPUT)
pin(REMOTEPOWER2_ON, PD4, OUTPUT)
pin(REMOTEPOWER2_OFF, PD5, OUTPUT)
pin(REMOTEPOWER1_ON, PD6, OUTPUT)
pin(REMOTEPOWER1_OFF, PD7, OUTPUT)
