...
pin(MBI5030_CLK0, PA4, OUTPUT)
pin(MBI5030_LE0, PA5, OUTPUT)
pin(MBI5030_SDO0, PA6, OUTPUT)

pin(MBI5030_CLK1, PA7, OUTPUT)

dnl pin(MBI5030_LE1, PA5, OUTPUT)
dnl pin(MBI5030_SDO1, PA6, OUTPUT)

pin(MBI5030_LE1, MBI5030_LE0)
pin(MBI5030_SDO1, MBI5030_SDO0)
